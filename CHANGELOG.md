...
- **copilot**: Add agentic coding harness
  ([#115](https://github.com/flumi3/markdown-refcheck/pull/115),
  [`b3c0f07`](https://github.com/flumi3/markdown-refcheck/commit/b3c0f07a358e86bb69ab557cd490dca1531e0438))

### Continuous Integration

- Add docs QA pipeline with Prettier, markdownlint, and refcheck
  ([#114](https://github.com/flumi3/markdown-refcheck/pull/114),
  [`dad2d01`](https://github.com/flumi3/markdown-refcheck/commit/dad2d0128c188988766cc05b9bcc4e9d0eb427e1))

* ci: add docs QA pipeline with Prettier, markdownlint, and refcheck

- Add Prettier (3.8.1) for Markdown formatting (prose wrap at 100 chars) - Add markdownlint-cli
  (0.48.0) for Markdown linting - Add refcheck (dogfooding) for broken reference validation - Add 7
  new Makefile targets: docs-format, docs-format-check, docs-lint, docs-lint-check, docs-refcheck,
  docs-qa, docs-qa-check - Add docs-qa job to build-validation.yml (parallel with test jobs) -
  Update make init to also install npm dependencies - Auto-format all existing Markdown files to
  comply - Exclude test fixtures from all docs QA checks

* ci: exclude CHANGELOG.md from Prettier formatting

CHANGELOG.md is auto-generated by semantic-release and should not be reformatted by the docs QA
  pipeline.

### Documentation

- Add Azure DevOps Pipelines integration section
  ([#113](https://github.com/flumi3/markdown-refcheck/pull/113),
  [`041d0f9`](https://github.com/flumi3/markdown-refcheck/commit/041d0f9daa8d8da4f3c24a897d4225aad17a39ca))

- Restructure documentation into user-guide and developer-guide
  ([#112](https://github.com/flumi3/markdown-refcheck/pull/112),
  [`a00331b`](https://github.com/flumi3/markdown-refcheck/commit/a00331bf0d57d2921e279b9181a51c23ff96f218))

- Create docs/user-guide/ for user-facing docs (CLI Reference, Ignoring References, Integration
  Guide) - Create docs/developer-guide/ for contributor docs (Development Guide) - Rewrite
  CLI-Reference.md: 413 -> 48 lines (concise table format) - Merge Examples.md +
  Integration-Guide.md into single Integration-Guide.md - Slim CONTRIBUTING.md: 344 -> 65 lines,
  link to Development Guide for details - Trim README.md: remove duplicate pre-commit/examples
  sections - Delete Examples.md and Understanding-Markdown-References.md (redundant) - Update
  pyproject.toml version_variables for new paths - Net reduction: ~1,377 lines of documentation

### Features

- **cli**: Add --quiet flag ([#118](https://github.com/flumi3/markdown-refcheck/pull/118),
  [`5b39af4`](https://github.com/flumi3/markdown-refcheck/commit/5b39af474ab1744f26eea24fdb3362dd39143e44))

* feat: add -q --quiet flag to enable minimal cli output

This helps reducing token usage if used with agents.

* refactor: merge colored prints into ui_print function

This is done to remove "if settings.no_color" conditions
