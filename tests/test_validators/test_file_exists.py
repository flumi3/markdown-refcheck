...
def test_file_exists_relative_path_in_subdirectory(mock_os_path_exists):
    mock_os_path_exists.side_effect = lambda path: path in [
        os.path.join("some/path", "subdir/relative_file.md")
    ]
...
def test_file_exists_absolute_path(
    ...
    mock_os_path_abspath.return_value = (
        "/absolute/path/file.md"  # Mock the absolute path of the origin file
    )
...
def test_file_does_not_exist_absolute_path(
    mock_os_path_exists, mock_os_path_abspath, mock_settings_absolute_path
):
    mock_os_path_exists.return_value = False
...
def test_file_exists_traverse_up_directory_tree(
    ...
    mock_os_path_abspath.return_value = (
        "/absolute/path/file.md"  # Mocking the absolute path of the origin file
    )
