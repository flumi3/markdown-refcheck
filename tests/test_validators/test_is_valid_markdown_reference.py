...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            False,
            False,
        ),  # Missing header in the same document
        (
            "other.md#existing-header",
            "doc.md",
            True,
            True,
            True,
        ),  # Valid reference to another file's header
        (
            "other.md#missing-header",
            "doc.md",
            True,
            False,
            False,
        ),  # Missing header in another file
        (
            "missing.md#some-header",
            "doc.md",
            False,
            False,
            False,
        ...
        (
            ...
            None,
            True,
        ),  # Valid Markdown file (no header reference)
...
def test_is_valid_markdown_reference(
    ...
    mock_header_exists.return_value = (
        header_exists_return if header_exists_return is not None else False
    )
